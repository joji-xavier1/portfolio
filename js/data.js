...
window.PORTFOLIO = {
  ...
  projects: [
    ...
    { num: '08', badge: 'AGRITECH', name: 'Agro-Net', client: 'Farmer Carbon-Credit Platform', blurb: 'Agri-tech app that lets farmers register, add land and crop details, and join carbon-credit projects — helping them earn through sustainable, eco-friendly cultivation while connecting them to a wider agricultural network.', tags: ['Flutter', 'AgriTech', 'Carbon Credits', 'Sustainability'] }
  ]
};
